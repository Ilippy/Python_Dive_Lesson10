...
class LotteryGame:
    ...
    def compare_lists(self):
        lists_overlap = list(set(self.list1) & set(self.list2))
        if lists_overlap:
            print("Совпадающие числа:", lists_overlap)
            print("Количество совпадающих чисел:", len(lists_overlap))
        else:
            print("Совпадающих чисел нет.")

        return lists_overlap
...
if __name__ == '__main__':
    ...
    # output:
    # Совпадающие числа: [3, 5, 8, 9, 41, 12, 14]
