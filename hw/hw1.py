...
# который возвращает категорию млекопитающего (Малявка, Обычный, Гигант) в зависимости от веса.
...
# который будет создавать экземпляры животных разных типов на основе переданного типа и параметров.
...
class Fish(Animal):
    ...
    def depth(self):
        # return ("Средневодная рыба", "Мелководная рыба", "Средневодная рыба")[(self.max_depth < 10) - (self.max_depth > 100)]
...
class Mammal(Animal):
    ...
    def category(self):
        return ("Обычный", "Малявка", "Гигант")[(self.weight < 1) - (self.weight > 200)]
